...
export default async function Hero() {
  ...
  return (
    <section className="mx-auto max-w-2xl px-4 sm:pb-6 lg:max-w-7xl  lg:px-8">
      <div className="mb-8 flex flex-wrap justify-between md:mb-6">
        <div className="mb-6 w-full flex flex-col justify-center sm:mb-12 lg:mb-0 lg:w-1/3 lg:pb-24 lg:pt-48">
          ...
          <p className="max-w-md leading-relaxed text-gray-500 xl:text-lg">
            We sell only the most exclusive and high quality produts for you. We
            are th best so come and shop with us.
          </p>
        </div>
